                    ...
                    <tbody>
                        @if (count($programList) > 0)
                            @foreach ($programList as $program)
                                <tr>
                                    <td>
                                        {{ ($programList->currentPage() - 1) * $programList->perPage() + $loop->iteration }}
                                    </td>
                                    <td>{{ $program->ptj->name }}</td>
                                    <td>{{ $program->kod }}</td>
                                        ...
                                        @hasanyrole('Superadmin|Admin')
                                            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                ...
                                                <span class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#deleteModal{{ $program->id }}"><i
            ...
            <div class="mt-3 d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-end align-items-center">
                    <span class="mx-2 mt-2 small text-muted">
                        Menunjukkan {{ $programList->firstItem() }} hingga {{ $programList->lastItem() }} daripada
                        {{ $programList->total() }} rekod
                    </span>
